...
<!-- header -->
  ...
  <div id='hlist'>
   <table id='auth'>
    <tr>
     <td>User</td>
     <td colspan='2'><input type='text' id='id' name='id' title='User' value='<?php echo $id; ?>'></td>
    </tr>
    <tr>
     <td>Password</td>
     <td colspan='2'><input type='password' id='pw' name='pw' title='Password' value='<?php echo $pw; ?>'></td>
    </tr>
    <tr>
     <td>OTP Password</td>
     <td colspan='2'><input type='number' id='pw2' name='pw2' title='OTP Password' max='999999'></td>
    </tr>
    <tr>
...
?>
       <a href='<?php echo $permalink; ?>'>
        <?php echo mb_substr($permalink, 0, 40); ?>...<?php echo mb_substr($permalink, mb_strlen($permalink)-60, 60); ?>
       </a>
      </div>
     </td>
    </tr>
