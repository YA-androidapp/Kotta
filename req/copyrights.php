<!-- Copyright (c) 2014-2015 YA-androidapp(https://github.com/YA-androidapp) All rights reserved. -->
  <div id="copyrights_list">
   ...
   <ul class="kotta">
    <li>
     <a href="https://github.com/YA-androidapp/Kotta">Kotta</a> <a href="https://github.com/YA-androidapp/Kotta"><img height="16px" width="16px" src="icon/kotta_s.png" /></a> Copyright &copy; <?php echo date('Y'); ?> 
