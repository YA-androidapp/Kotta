<!-- Copyright (c) 2014 YA-androidapp(https://github.com/YA-androidapp) All rights reserved. -->
  <div id="copyrights_list">
   <ul>
    <li><a href="https://github.com/YA-androidapp/Kotta">Kotta</a> <a href="https://github.com/YA-androidapp/Kotta"><img height="16px" width="16px" src="icon/kotta_s.png" /></a> Copyright &copy; <?php echo date('Y'); ?> 
...
YA
    ...
    <li>Libraries
     <ul>
      ...
      <li>
       Other Licence:
       <a href="#" onClick="NoRefererRedirect('https://github.com/abraham/twitteroauth')">twitteroauth</a><small>(<a href="#" onClick="NoRefererRedirect('https://github.com/abraham/twitteroauth/blob/master/LICENSE')">LICENSE</a>)</small>
      </li>
     </ul>
    </li>
   </ul>
