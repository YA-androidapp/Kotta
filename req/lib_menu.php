...
<?php } ?>
    ...
    <tr class='source'>
     ...
     <td>
      <input type='text' id='dir' name='dir' onclick='jQuery(\'#dir\').css(\'background-color\',\'#fff\');jQuery(\'#favname,#m3uuri\').css(\'background-color\',\'#ccc\')' value='<?php echo @str_replace($base_dir, '', @str_replace($base_dir.'/', '', $_REQUEST['dirname'])); ?>' style='width:200px;' />
     </td>
    </tr>
    <tr class='source'>
     <td>お気に入り</td>
     <td>
      <input type='text' id='favname' name='favname' onclick='jQuery(\'#favname\').css(\'background-color\',\'#fff\');jQuery(\'#dir,#m3uuri\').css(\'background-color\',\'#ccc\')' value='<?php echo ($_REQUEST['favname']!='') ? $_REQUEST['favname'] : @$_SESSION['favname']; ?>' style='width:200px;' />
     </td>
    </tr>
    <tr class='source'>
     <td>M3UプレイリストのURL</td>
     <td><input type='text' id='m3uuri' name='m3uuri' onclick='jQuery(\'#m3uuri\').css(\'background-color\',\'#fff\');jQuery(\'#dir,#favname\').css(\'background-color\',\'#ccc\')' value='<?php echo ($_REQUEST['m3uuri']!='') ? $_REQUEST['m3uuri'] : @$_SESSION['m3uuri']; ?>' style='width:200px;' /></td>
    </tr>
    <tr class='source'>
     <td>読み込む階層の深さ</td>
     <td>
