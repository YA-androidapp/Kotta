...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
        ...
        $this->options = array(
            'script_url' => asep($this->get_full_url(),''),
            'upload_dir' => asep($base_dir,'').asep($arguments['dirname'],''),
            'upload_url' => asep($base_uri,'').asep($arguments['dirname'],''),
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function get_upload_path($file_name = null, $version = null) {
        ...
        $version_path = empty($version) ? '' : asep($version,'');
    ...
    protected function get_download_url($file_name, $version = null) {
        ...
        $version_path = empty($version) ? '' : asep(rawurlencode($version),'');
    ...
    protected function create_scaled_image($file_name, $version, $options) {
        ...
        if (!empty($version)) {
            ...
            $new_file_path = asep($version_dir,$file_name);
        } else {
